...
function Register() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#F7F8FC] p-4 font-['Poppins'] sm:p-8">
      ...
      <div className="relative flex w-full max-w-6xl overflow-hidden rounded-[26px] bg-white shadow-[0_40px_80px_-30px_rgba(70,60,160,0.28)]">
        {/* Left hero panel */}
        {width >= 768 && (
          <div
            className="relative hidden w-[34%] shrink-0 flex-col overflow-hidden rounded-l-[26px] bg-gradient-to-br from-[#0B3D73] to-[#002864] px-8 py-[34px] md:flex"
          >
        ...
        <div className="relative z-20 flex w-full flex-col bg-white px-6 py-10 sm:px-10 md:w-[66%] md:-ml-[30px] md:rounded-[34px_16px_16px_34px] md:px-[46px] md:py-8 lg:px-[56px]">
          {width >= 768 && (
          ...
          <div className="mx-auto flex w-full max-w-xl flex-1 flex-col justify-center py-4">
            ...
            <h1 className="text-2xl font-bold text-gray-800 tracking-tight">{t("create-account")}</h1>
            ...
            <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-0 border-b border-gray-200 bg-transparent px-0.5 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:border-[#5B5EF7] focus:outline-none focus:ring-0 transition-colors"
                  />
                </div>
                <div>
              ...
              <div className="mt-2 flex items-center gap-2">
                <input
                  type="checkbox"
                  id="agreeTerms"
                  className="w-4 h-4 text-[#5B5EF7] border-gray-300 rounded focus:ring-[#5B5EF7] accent-[#5B5EF7] cursor-pointer"
                  checked={agreeTerms}
                ...
                <label htmlFor="agreeTerms" className="cursor-pointer text-xs text-gray-500 font-semibold selection:bg-transparent select-none">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-[#5B5EF7] hover:underline"
                  >
                    Terms
                  </a>{" "}
                  and{" "}
            ...
            <p className="mt-8 text-center text-xs text-gray-500 font-medium">
              ...
              <NavLink to="/login" className="text-[#5B5EF7] font-bold hover:underline">
                {t("login")}
              </NavLink>
            </p>
          </div>
