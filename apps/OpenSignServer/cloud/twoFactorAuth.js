...
export async function createAndSendOtp(extUser, purpose, extraFields = {}) {
  ...
  await sendSystemMail({
    params: {
      ...
      html: `<p>Your ${appName} verification code is:</p><h2 style="letter-spacing:4px;">${otp}</h2><p>This code expires in 5 minutes. If you didn't request this, you can ignore this email.</p>`,
