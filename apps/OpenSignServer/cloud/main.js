...
import getTenantUsage from './parsefunction/getTenantUsage.js';
import sendTwoFactorSetupOtp from './parsefunction/sendTwoFactorSetupOtp.js';
import verifyTwoFactorSetupOtp from './parsefunction/verifyTwoFactorSetupOtp.js';
import disableTwoFactor from './parsefunction/disableTwoFactor.js';
import verifyLoginOtp from './parsefunction/verifyLoginOtp.js';
...
import submitApprovalGoogle from './parsefunction/submitApprovalGoogle.js';
...
export default function registerCloudCode() {
  ...
  Parse.Cloud.define('gettenantusage', getTenantUsage);
  Parse.Cloud.define('sendtwofactorsetupotp', sendTwoFactorSetupOtp);
  Parse.Cloud.define('verifytwofactorsetupotp', verifyTwoFactorSetupOtp);
  Parse.Cloud.define('disabletwofactor', disableTwoFactor);
  Parse.Cloud.define('verifyloginotp', verifyLoginOtp);
  ...
  Parse.Cloud.define('submitapprovalgoogle', submitApprovalGoogle);
